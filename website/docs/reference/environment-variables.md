...
| `HERMES_SKILLS_DIR` | Override the primary read-write skills directory for this process. Takes precedence over `skills.dir` in `config.yaml`; relative paths resolve against `HERMES_HOME`. |
