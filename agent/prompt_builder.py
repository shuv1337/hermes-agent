...
_MEDIA_NATIVE = (
    "You can send files natively: write the `MEDIA:` marker immediately "
    "followed by the file's absolute path in your response. "
)
...
PLATFORM_HINTS = {
    ...
    "desktop": (
        ...
        "Deliver files by writing the `MEDIA:` marker immediately followed by the file's absolute path — any file "
